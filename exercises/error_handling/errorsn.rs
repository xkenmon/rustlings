...
fn read_and_validate(
    ...
    // answer 2.
    // fn f(e: CreationError) -> Result<PositiveNonzeroInteger, Box<dyn error::Error>> {
    //     Err(Box::new(e))
    // }
    // PositiveNonzeroInteger::new(num).or_else(f)

    // answer 3.
    PositiveNonzeroInteger::new(num).or_else(|e| Err(Box::new(e).into()))
